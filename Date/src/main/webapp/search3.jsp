...
<style type="text/css">
    ...
    .search-info{padding-left: 10px;width: 100px;margin-right: 100px;}
</style>
...
<div class="input-group">
    <div class="bg-div">
        <h3 style="height:53px;width: 150px; float: left;margin: 100px 0 0 570px;color: white">关键描述搜索</h3>
        <div class="search-box">
            <form class="search-form" action="./descriptionSearch" method="get" accept-charset="utf-8">
                <input type="text" class="search-text" name="description"/>
